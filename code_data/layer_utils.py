...
from code_data.fast_layers import *
...
def conv_relu_pool_forward(x, w, b, conv_param, pool_param, conv_layer_num):
    """
    ...
    if pool_param['use_pool'][conv_layer_num]:
...
def conv_norm_relu_pool_forward(x, w, b, conv_param, pool_param, gamma, beta, bn_param, conv_layer_num):
    """Convenience layer that performs a convolution, spatial
    batchnorm, a ReLU, and a pool.
